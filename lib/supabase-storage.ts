...
/**
 * Uploads any file (PDF, etc.) to the Supabase "tns-images" bucket.
 *
 * @param file The file object (from FormData)
 * @param folder The folder inside the bucket (e.g. 'politicas')
...
export async function uploadFileToSupabase(
  ...
  if (error) {
    console.error('Supabase upload error:', error);
    throw new Error('Error al subir el archivo a Supabase: ' + error.message);
  }
