...
async function main() {
  ...
  await prisma.client.createMany({
    data: [
      {
        name: 'Ecopetrol',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/ecopetrol.svg',
        websiteUrl: 'https://www.ecopetrol.com.co',
        order: 1,
      },
      {
        name: 'Terpel',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/terpel.png',
      ...
      {
        name: 'Coagronorte',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/coagronorte.webp',
        websiteUrl: 'https://coagronorte.com.co',
        order: 8,
      },
      {
        name: 'Inveragro',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/inveragro.png',
        websiteUrl: 'https://inveragro.com.co',
        order: 9,
      },
      {
        name: 'Psl Proanalisis',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/psl-pronalisis.png',
        websiteUrl: 'https://pslproanalisis.com',
        order: 10,
      },
      {
        name: 'Rafael del Castillo',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/rafael.png',
        websiteUrl: 'https://rafaeldelcastillo.com.co',
        order: 11,
      },
      {
        name: 'Arrocera Gelves',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/arroz-gelvez.png',
        websiteUrl: 'https://gelvezdistribuciones.com',
        order: 12,
      },
      {
        name: 'Arrocera Agua Clara',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/arrocera-aguaclara.png',
        websiteUrl: '',
        order: 13,
      },
      {
        name: 'Unionagro',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/unionagro.png',
        websiteUrl: '',
        order: 14,
      },
      {
        name: 'Centro de Arroces',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/centro-arroces.png',
        websiteUrl: '',
        order: 15,
      },
      {
        name: 'Comercializadora Gran señora',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/granse%C3%B1ora.png',
        websiteUrl: '',
        order: 16,
      },
      {
        name: 'Coopecafenor',
        logoUrl: 'https://pwxvctdmbiuhvswfsjln.supabase.co/storage/v1/object/public/tns-images/clientes/coopecafenor.png',
        websiteUrl: '',
        order: 17,
      }
    ]
